...
export const DYNAMIC_PUBLIC_PATHS = Object.freeze([
  '/assets/bees/bee1_body.png',
  '/assets/bees/bee1_wing.png',
  '/assets/bees/bee2_body.png',
  '/assets/bees/bee2_wing.png',
  '/assets/bees/bee3_body.png',
  '/assets/bees/bee3_wing.png',
  '/assets/conferences/conf-1.avif',
  '/assets/conferences/conf-2.avif',
  '/assets/conferences/conf-3.avif',
  '/assets/conferences/conf-4.avif',
  '/assets/conferences/conf-5.avif',
  '/assets/conferences/conf-6.avif',
  '/assets/conferences/conf-clip.mp4',
  '/assets/conferences/conf-clip-poster.jpg',
  '/assets/conferences/conf-config-a.jpg',
  '/assets/conferences/conf-config-b.jpg',
  '/assets/conferences/conf-config-c.jpg',
  '/assets/conferences/conf-config-clip.mp4',
  '/assets/conferences/conf-config-group.jpg',
  '/assets/conferences/conf-config-poster.jpg',
  '/mockups/assets/excuse-poster.webp',
  '/mockups/assets/fogmirror-poster.jpg',
  '/mockups/assets/sayit-poster.svg',
  '/mockups/lab-butterfly.html',
  '/mockups/lab-chiaroscuro.html',
  '/mockups/lab-compounding.html',
  '/mockups/lab-dharma.html',
  '/mockups/lab-domino.html',
  '/mockups/lab-emergence.html',
  '/mockups/lab-entropy.html',
  '/mockups/lab-excuse.html',
  '/mockups/lab-fogmirror.html',
  '/mockups/lab-line.html',
  '/mockups/lab-marble.html',
  '/mockups/lab-pentimento.html',
  '/mockups/lab-sayit.html',
  '/mockups/lab-sfumato.html',
  '/mockups/lab-vanishing.html',
]);
